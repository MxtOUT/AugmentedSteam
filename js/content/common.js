...
class ITAD {
    ...
    static async getAppStatus(storeIds) {
        ...
        let promises = [];
        let emptyResult = Promise.resolve(multiple ? {} : false);

        if ((highlightCollection || highlightWaitlist) && await Background.action("itad.isconnected")) {
            ...
            promises.push(emptyResult, emptyResult);
        }
